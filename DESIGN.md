...
*(Civ VI–inspired, path‑first MVP)*
...
### H) Mini‑map (M1) — *Optional for MVP*
...
*(Implementation happens after structure works. Keep subtle, no heavy animations.)*
...
*This file + CONTEXT.md + PROGRESS.md are the minimum onboarding kit for any new contributor or LLM.*
